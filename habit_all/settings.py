"""
Django settings for habit_all project.
...
SECRET_KEY = 'django-insecure-(4_g0_09llq#pkn*yq-0m&!9q8r1cx4g(8-7v*9m^p_qvf!l$$'
...
WSGI_APPLICATION = 'habit_all.wsgi.application'
